    ...
    <BrowserRouter>
      <div className="container">
        ...
        <Routes>
          ...
          <Route
            path="/problems/block/:problemId/next/final/quiz"
            element={<QuizPage />}
          />
          <Route
            path="/problems/block/:problemId/next/final/quiz/check"
            element={<QuizCheckPage />}
          />
          <Route
            path="/problems/block/:problemId/next"
            element={<NextBlockPage />}
          />
          <Route
            path="/problems/block/:problemId/next/final"
            element={<FinalBlockPage />}
          />
        </Routes>
      </div>
    </BrowserRouter>
