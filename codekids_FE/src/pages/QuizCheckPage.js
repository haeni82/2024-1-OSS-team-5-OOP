        ...
        <>
          <div className="topdiv">
            {item.isCorrect ? (
              ...
              <img
                className="correctImg"
                src={`${process.env.PUBLIC_URL}/incorrect.png`}
                alt="오답"
              />
            )}
          ...
          <div className="bottomdiv">
            {whatQuizType(item.questionType) ? (
              <>
                <button className="OXBtn">O</button>
                <button className="OXBtn">X</button>
              </>
            ) : (
              item.questionMulti &&
              ...
              item.questionMulti.map((choice, choiceIdx) => (
                <div key={choiceIdx}>
                  <button className="fiveBtn">{choice.choice}.</button>
                  <span className="fivetext">{choice.detail}</span>
                </div>
              ))
            )}
            <p className="descrip">
              정답: {item.correctAnswer} 해설: {item.questiondescription}
            </p>
          </div>
        </>
      ))}
